...
_PROFILE_OVERRIDES: dict[str, dict[str, str]] = {
    "crude_tankers": {
        ...
        "market_cycle_watch": "Watch Brent/WTI, crude inventories, global PMI, relative sector price, and valuation proxy together; a durable turn should show improving relative price before valuation fully normalizes.",
        "why_now": "Oil inventories, Brent/WTI prices, and global PMI proxies can flag when oil trade activity is improving before public tanker sentiment has fully recovered.",
    ...
    "product_chemical_tankers": {
        ...
        "market_cycle_watch": "Track distillate inventories, Brent, global PMI, USD/NOK, relative price, and valuation proxy; product tankers can diverge from crude tankers when refinery geography changes.",
    },
    "dry_bulk": {
        ...
        "market_cycle_watch": "Copper, aluminum, China growth proxy, global PMI, relative price, and valuation proxy are the minimum factor set before calling a cycle recovery.",
    },
    "lng_lpg_shipping": {
        ...
        "market_cycle_watch": "Watch gas prices, Brent, global PMI, USD/NOK, relative price, valuation proxy, and vessel-supply commentary.",
    },
    "offshore_vessels_drilling": {
        ...
        "market_cycle_watch": "Oil curve pressure, Brent, global PMI, USD/NOK, relative price, valuation proxy, and order/backlog evidence should move in the same direction.",
    ...
    "oil_services": {
        ...
        "market_cycle_watch": "Track Brent, global PMI, USD/NOK, rates pressure, relative price, valuation proxy, and backlog/order commentary.",
    },
    "seafood_aquaculture": {
        ...
        "market_cycle_watch": "Food-price pressure, USD/NOK, EUR/NOK, global PMI, relative price, valuation proxy, salmon price/volume evidence, and regulatory events are the core dashboard set.",
    },
    "metals_aluminum": {
        ...
        "market_cycle_watch": "Aluminum, copper, global PMI, EUR/NOK, relative price, valuation proxy, and World Bank commodity context should be reviewed together.",
    },
    "renewables": {
        ...
        "market_cycle_watch": "Rates pressure, EUR/NOK, global PMI, copper, relative price, valuation proxy, auctions, impairments, and funding spreads are the relevant cycle picture.",
    ...
    "industrial_tech_exporters": {
        "cycle_conclusion": "Industrial and tech exporters are a mixed global capex, AI, FX, and order-intake lane. A cycle upgrade needs global PMI and technology capex proxies to confirm relative price strength.",
        ...
        "market_cycle_watch": "Global PMI, Nasdaq proxy, USD/NOK, EUR/NOK, relative price, valuation proxy, and order-intake commentary should be reviewed together.",
    },
}
