...
SUBSECTORS: tuple[Subsector, ...] = (
    Subsector(
        ...
        ("brent", "wti", "us_crude_stocks", "g20_cli", "global_pmi", "usd_nok"),
    ...
    Subsector(
        ...
        ("brent", "us_distillate_stocks", "g20_cli", "global_pmi", "usd_nok"),
    ...
    Subsector(
        ...
        ("copper", "aluminum", "g20_cli", "china_cli", "china_growth_proxy"),
    ...
    Subsector(
        ...
        ("us_natural_gas", "brent", "g20_cli", "global_pmi", "usd_nok"),
    ...
    Subsector(
        ...
        ("brent", "oil_curve_pressure", "g20_cli", "global_pmi", "usd_nok"),
    ...
    Subsector(
        ...
        ("brent", "g20_cli", "global_pmi", "usd_nok", "rates_pressure"),
    ...
    Subsector(
        ...
        ("food_price_pressure", "usd_nok", "eur_nok", "g20_cli", "global_pmi"),
    ...
    Subsector(
        ...
        ("aluminum", "copper", "g20_cli", "china_cli", "eur_nok"),
    ...
    Subsector(
        ...
        ("rates_pressure", "eur_nok", "europe_cli", "g20_cli", "copper"),
    ...
    Subsector(
        ...
        ("g20_cli", "us_cli", "nasdaq_proxy", "usd_nok", "eur_nok"),
