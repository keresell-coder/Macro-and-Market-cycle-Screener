...
SOURCE_DEFINITIONS: tuple[SourceDefinition, ...] = (
    SourceDefinition("fred_public", "FRED public CSV downloads", "https://fred.stlouisfed.org/graph/fredgraph.csv", "download", "public", "Keyless public CSV downloads for selected macro, rates, financial-conditions, stress, FX, and valuation dependencies, including Chicago Fed NFCI, St. Louis Fed Financial Stress Index, GDP, and Fed Z.1 corporate-equity market-value series."),
